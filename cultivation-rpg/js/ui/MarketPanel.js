const MarketPanel = {
    ...
    render(scene, items, x, y, opts) {
        ...
        // Background
        this._elems.push(scene.add.rectangle(x, y, panelW + 8, visible.length * itemH + 16, 0x20352f, 0.94)
            .setStrokeStyle(1, 0x8ed3b0).setScrollFactor(0).setDepth(200));
        ...
        for (let i = 0; i < visible.length; i++) {
            ...
            const rowBg = scene.add.rectangle(x, iy, panelW, itemH - 2,
                i % 2 === 0 ? 0x263d36 : 0x20352f, 1)
                .setStrokeStyle(1, 0x385b50).setScrollFactor(0).setDepth(201);
            ...
            this._elems.push(scene.add.text(x + panelW / 2 - 60, iy, price + '灵石', {
                fontSize: '10px', fill: '#fff0b8', fontFamily: 'monospace'
