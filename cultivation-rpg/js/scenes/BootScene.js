class BootScene extends Phaser.Scene {
    ...
    _generatePlaceholderTextures() {
        ...
        const pColors = { hair: '#1d2430', skin: '#f1c38d', robe: '#2f8f83', inner: '#e6f4d8', pants: '#263d36', shoes: '#332211', belt: '#ffd166', eyes: '#17201d' };
        ...
        const nColors = { hair: '#1d1725', skin: '#eebb77', robe: '#8f6b55', inner: '#ffe0a3', pants: '#445533', shoes: '#332211', belt: '#ffd166', eyes: '#222222' };
        for (let dir = 0; dir < 4; dir++) {
            for (let f = 0; f < 2; f++) {
        ...
        const terCanvas = this.textures.createCanvas('terrain', 512, 32);
        const tctx = terCanvas.context;
        const tileColors = ['#7cae75', '#8bbf7e', '#3f93a6', '#8a8f80', '#2f7d58', '#c59761', '#5c4b6d', '#6b557c', '#dac46f', '#a8d1a0', '#b7d2c6', '#e9f8ff', '#c9d7d8', '#493c64', '#5b4a72', '#6b5062'];
        for (let i = 0; i < 16; i++) {
            const ox = i * 32;
        ...
        for (let i = 0; i < 16; i++) { ttex.add(i, 0, i * 32, 0, 32, 32); }
    }
