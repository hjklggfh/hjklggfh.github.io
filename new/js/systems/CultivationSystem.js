const CultivationSystem = {
    ...
    attemptBreakthrough(pillBonus) {
        ...
        if (success) {
            ...
            // Update HP to new rank base (don't compound equipment into base)
            GameState.playerBaseStats.hp = 100 + nextData.statBonus.hp;
            GameState.maxHP = GameState.playerBaseStats.hp;
